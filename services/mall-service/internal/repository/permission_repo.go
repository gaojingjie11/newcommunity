...
// GetPermissionCodesByUserID returns all permission codes for a user via their roles.
// Queries sys_user_role → sys_role_permission → sys_permission (shared RBAC tables).
