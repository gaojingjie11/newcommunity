...
type ListMyFeesLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewListMyFeesLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListMyFeesLogic {
	return &ListMyFeesLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ListMyFeesLogic) ListMyFees(in *community.ListPropertyFeesReq) (*community.PropertyFeeListResp, error) {
	fees, total, err := l.svcCtx.PropertyFeeRepo.ListByUser(in.UserId, int(in.Page), int(in.Size))
	if err != nil {
		return nil, err
	}
